...
public class EmailUtils {
  ...
  private static String USERNAME = "service@yikeshangshou.com";
  ...
  static {
    ...
    users.put("no-reply@yikeshangshou.com", PASSWORD);
    users.put("notification@yikeshangshou.com", PASSWORD);
  }
