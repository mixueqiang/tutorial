          ...
          <c:when test="${not empty _user}">
            <div class="dropdown headerDropdown">
              <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown">
                <%-- <img alt="${sessionScope._user.username}" title="${sessionScope._user.username},查看更多个人信息" class="img-responsive "src="http://img3.imgtn.bdimg.com/it/u=3799866287,2225466980&fm=23&gp=0.jpg"> --%><a href="/dashboard">${_user.username}</a>
