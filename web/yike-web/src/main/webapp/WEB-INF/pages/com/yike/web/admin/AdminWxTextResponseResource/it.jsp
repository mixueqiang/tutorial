  ...
  <div class="row">
	...
	<div class="panel-body">
	  <table class="table table-condensed table-hover" id="responses">
		...
		<td data-id="${item.id}" data-target="${item.target}" data-result="${item.result}"><a id="editButton" class="glyphicon glyphicon-pencil editbtn" href="javascript:;" title="编辑" role="button" data-toggle="modal" data-target="#editModal"></a></td>
	      </tr>
	    </c:forEach>
	    </tbody>
	  </table>
