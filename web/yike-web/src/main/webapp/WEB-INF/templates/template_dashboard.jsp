    ...
    <div class="row">
      <div class="col-md-3 col-sm-4">
        <div class="panel panel-default row-space-4">
          <div class="panel-body">
            <div class="media media-photo-block">
              <img title="${sessionScope._user.username}" class="img-responsive"
                <c:choose>
                 <c:when
                     test="${not empty sessionScope._user.avatar}">src="http://yikeyun.b0.upaiyun.com/${sessionScope._user.avatar}!M"
            </c:when>
                 <c:otherwise>src="" style="display:none;"</c:otherwise>
            </c:choose>>
            </div>
        ...
        <div class="panel panel-default row-space-4">
          ...
          <div class="panel-body">
            <ul class="list-unstyled template-navList">
              <li>
              ...
              <li>
                <div class="alert alert-success">
                  <a href="/courses/as_an_instructor"><span class="glyphicon glyphicon-user" aria-hidden="true"></span><span>我发布的课程</span></a>
                </div>
              </li>
              <li>
                <div class="alert alert-success">
